...
class SuperNavWalker extends \Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $page, $depth = 0, $args = [], $current_page = 0) {
        ...
        if($mega_menu != '' && class_exists('\Elementor\Plugin')) {
            ...
            $mega_menu_html = '<div class="se-mega-menu sub-menu">'.$elementor->frontend->get_builder_content_for_display(  $mega_menu  ).'</div>';
        }
