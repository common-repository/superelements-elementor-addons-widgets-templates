...
<div class="testimonial-slider <?php echo esc_attr($layout)?>" data-slick="<?php echo esc_attr(wp_json_encode($data_slick)); ?>">
    <?php foreach ($testimonials as $testimonial) :?>
        ...
        ?>
        <div class="slide-container se-transition-all se-duration-300 se-border se-border-brand/20 se-rounded-lg se-p-5">
            ...
            <div class="se-flex se-items-start se-gap-4">
